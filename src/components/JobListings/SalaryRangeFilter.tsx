    ...
    <div className="space-y-4">
      ...
      <div className="relative pt-2">
        ...
        <input
          ...
          className="absolute w-full h-2 top-2 appearance-none bg-transparent pointer-events-none [&::-webkit-slider-thumb]:pointer-events-auto [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-5 [&::-webkit-slider-thumb]:h-5 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-primary [&::-webkit-slider-thumb]:cursor-pointer [&::-webkit-slider-thumb]:border-2 [&::-webkit-slider-thumb]:border-white [&::-webkit-slider-thumb]:shadow-md"
        />
      ...
      <div className="flex items-center gap-3">
        <input
          ...
          readOnly
          className="flex-1 px-3 py-2 text-sm text-center border border-gray-200 rounded-lg bg-gray-50"
        />
        <span className="text-gray-400">—</span>
        <input
          type="text"
          value={localMax >= maxSalary ? '₹8,00,000+' : `₹${localMax.toLocaleString('en-IN')}`}
          readOnly
          className="flex-1 px-3 py-2 text-sm text-center border border-gray-200 rounded-lg bg-gray-50"
        />
      </div>
